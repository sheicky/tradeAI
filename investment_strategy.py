        ...
        signal = {
            ...
            "market_context": {
                "vix_level": (
                    ...
                    else "Moderate" if indicators["VIX"] > 15 else "Low"
                ),
                "interest_rate_environment": (
                    "High"
                    if indicators["USGG10YR"] > 4
                    else "Moderate" if indicators["USGG10YR"] > 2 else "Low"
                ),
                "gold_trend": (
                    "Bullish"
                    if indicators["XAU BGNL"] > 2000
                    else "Neutral" if indicators["XAU BGNL"] > 1800 else "Bearish"
                ),
            },
        }
